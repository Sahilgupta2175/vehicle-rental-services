...
const AdminDashboard = () => {
  ...
  const loadUsers = async () => {
    try {
      ...
      const nonAdminUsers = (data.users || data).filter(
        (u) => u.role !== "admin",
      );
  ...
  const handleRemoveVendor = async (id, vendorName) => {
    if (
      !window.confirm(
        `Are you sure you want to remove vendor "${vendorName}"? This will also delete all their vehicles and cannot be undone.`,
      )
    ) {
      return;
    }
          ...
          <div className="relative flex items-start gap-5">
            ...
            <div>
              ...
              <p className="text-slate-400 text-base">
                Manage users, vendors, and system analytics
              </p>
            </div>
          </div>
                  ...
                  >
                    ...
                    {booking.pickup?.extensionRequested &&
                      booking.pickup?.extensionReason && (
                        <p className="text-xs text-amber-300 mt-2 bg-amber-500/10 border border-amber-500/30 rounded px-2 py-1">
                          Late reason: {booking.pickup.extensionReason}
                        </p>
                      )}
                  </div>
                ))}
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-400">
                    Manage vendors and their approval
                  </p>
                </div>
              </div>
          ...
          <div className="bg-slate-900/50 backdrop-blur-sm border border-slate-800 rounded-3xl p-6 shadow-xl">
            ...
            <div className="space-y-4">
              {recentBookings.map((booking) => (
                <div
                  key={booking._id}
                  className="bg-slate-800/50 rounded-xl p-5 border border-slate-700 hover:border-blue-500/30 transition-all"
                >
          ...
          <div className="bg-slate-900/50 backdrop-blur-sm border border-slate-800 rounded-3xl p-6 shadow-xl">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-sm text-slate-400">
                  Download detailed monthly analytics
                </p>
              </div>
            </div>
