        ...
        <div className="card card-hover group overflow-hidden">
                ...
                {vehicle.isAvailable !== undefined && (
                    <div className="absolute top-3 right-3">
                        <span className={`inline-flex items-center gap-1.5 text-xs font-semibold px-3 py-1.5 rounded-full backdrop-blur-md border ${
                            ...
                            <span className={`w-1.5 h-1.5 rounded-full ${vehicle.isAvailable ? 'bg-success' : 'bg-red-400'}`}></span>
            ...
            <div className="p-5 space-y-4">
                    ...
                    <div className="flex justify-between items-start gap-2">
                        ...
                        {vehicle.pricePerHour && (
                            <div className="text-right flex-shrink-0">
                                ...
                                <div className="text-xl font-bold text-primary">₹{vehicle.pricePerHour}</div>
                ...
                <Link
                    ...
                    className="block w-full text-center px-4 py-3 rounded-xl bg-gradient-to-r from-primary to-primary-dark text-white font-medium shadow-lg shadow-primary/20 hover:shadow-primary/40 hover:-translate-y-0.5 transition-all duration-200"
                >
                    View Details
                </Link>
            </div>
